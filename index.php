<?php
session_start();
ini_set('display_errors', 0); // 0 cache / 1 affiche | Ne jamais afficher d'erreurs en production
...
<html>
  ...
  <header class="header" id="head">
    ...
    <section class="section" style="padding: 4rem 2rem;">
      <h2>Prêt de matériel <span style="border-bottom: 4px solid #0f2b3c;"></span></h2>
      <div class="grid">
        <div>
      ...
      <div>
        <img src="./img/h2-background.jpg" alt="Stock matériel" style="width: 40%; border: 1px solid #000;">
      </div>
    </div>
  </section>
  ...
  <section class="section" style="padding: 4rem 2rem;">
    <div class="grid">
      <div>
        <img src="./img/verif_icon.png" alt="Checklist" style="width: 40%;">
      </div>
      <div>
  ...
  <section class="logo-banner">
    <div class="banner-columns">
      <div class="side-blank left"></div>
      <div class="center-content">
        <img src="./img/logo_pret.png" alt="INFO'MAINTENANCE">
        <a class="btn" href="https://www.info-maintenance.fr/">Site internet</a>
      </div>
      <div class="side-blank right"></div>
    </div>
  </section>
  <div class="bar-cyan"></div>
  ...
  <!-- Section De plus -->
    ...
    <h2>De plus <span style="border-bottom: 4px solid #0f2b3c;"></span></h2>
    <div class="grid-4">
      <div>
        <h4>🗺 Aide</h4>
