...
function generateBinaryTag(): string {
...
foreach ($materielData as $data) {
    ...
    $etiquetteHex = strtoupper(bin2hex($etiquette));
    $qrCode = new QrCode($etiquetteHex);
    ...
    $result->saveToFile($qrPath . $etiquetteHex . '.png');

    echo "\n✅ $nom | Type: $id_type_materiel | Etat: $id_etat_materiel | $provenance | QR: $etiquetteHex";
}

echo "\n\n🎉 30 matériels insérés avec QR codes générés dans /qrcodes\n";
?>